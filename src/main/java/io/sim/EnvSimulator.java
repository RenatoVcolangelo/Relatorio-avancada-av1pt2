...
/**
 * Classe responsável por iniciar e gerenciar todos os componentes do ambiente de simulação:
 * SUMO, banco (AlphaBank), posto de combustível, empresa e os motoristas com seus carros.
 */
